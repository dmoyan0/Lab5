...
const (
	Broker_SendAddress_FullMethodName = "/Broker/SendAddress"
)
...
const (
	...
	Fulcrum_GetVectorClock_FullMethodName = "/Fulcrum/getVectorClock"
)
...
func (c *fulcrumClient) GetVectorClock(ctx context.Context, in *CommandRequest, opts ...grpc.CallOption) (*VectorClockResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VectorClockResponse)
	err := c.cc.Invoke(ctx, Fulcrum_GetVectorClock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Fulcrum_GetVectorClock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Fulcrum_GetVectorClock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
